...
class Post
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Application\Sonata\ClassificationBundle\Entity\Category", inversedBy="articles")
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Application\Sonata\ClassificationBundle\Entity\Category", inversedBy="tagged")
    ...
    /**
     * @ORM\OneToMany(targetEntity="BlogBundle\Entity\PostMeta", mappedBy="article", cascade={"persist", "remove"}, orphanRemoval=true)
     */
    protected $metaData;
