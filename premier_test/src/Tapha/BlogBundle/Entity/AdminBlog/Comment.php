...
use Tapha\BlogBundle\Validator\Constraints AS TaphaAssert;
...
class Comment
{
     ...
     * @TaphaAssert\ClientIp(groups="ip_control_group")
     */
    private $ip;
     ...
     * Set post
     *
     * @param \Tapha\BlogBundle\Entity\AdminBlog\Post $post
     * @return Comment
     */
    public function setPost(\Tapha\BlogBundle\Entity\AdminBlog\Post $post = null)
    {
        $this->post = $post;
     ...
     * Get post
     *
     * @return \Tapha\BlogBundle\Entity\AdminBlog\Post 
     */
