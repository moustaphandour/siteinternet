...
class CategoryType extends AbstractType
{
    ...
    {
        $builder
            ->add('title', null, array('label' => 'form.category.title', 'translation_domain' => 'TaphaBlogBundle'))
            ->add('description', null, array('label' => 'form.category.description', 'translation_domain' => 'TaphaBlogBundle'))
        ;
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Tapha\BlogBundle\Entity\AdminBlog\Category'
        ));
    }

    public function getName()
    {
        return 'tapha_blogbundle_blog_categorytype';
    }
}
